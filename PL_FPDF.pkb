...
begin
  ...
  -- Generate PIX payload using external package
  l_payload := PL_FPDF_PIX.GetPixPayload(p_pix_data);
...
--------------------------------------------------------------------------------
-- Task 3.8: Barcode Generation with Boleto Support - Rendering Procedures
-- Note: Boleto utility functions (CalculateFatorVencimento, CalculateDVBoleto,
...
begin
  ...
  -- Generate barcode using external package
  l_codigo := PL_FPDF_BOLETO.GetCodigoBarras(p_boleto_data);
