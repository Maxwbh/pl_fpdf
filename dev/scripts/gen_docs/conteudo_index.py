...
EXEMPLOS = {
    ...
    'blocos': [
        ...
        ("imagem", "",
         "<picture>\n<source srcset=\"assets/exemplo-boleto.webp\" type=\"image/webp\">\n<img src=\"assets/exemplo-boleto.png\" width=\"560\" height=\"696\" loading=\"lazy\" decoding=\"async\"\nstyle=\"max-width:100%;height:auto;border-radius:10px;box-shadow:0 10px 40px rgba(0,0,0,.35)\"\nalt=\"Boleto bancário gerado pelo PL_FPDF: duas vias, grade de campos e código de barras ITF\">\n</picture>",
        ...
        ("imagem", "",
         "<picture>\n<source srcset=\"assets/exemplo-ticket.webp\" type=\"image/webp\">\n<img src=\"assets/exemplo-ticket.png\" width=\"470\" height=\"642\" loading=\"lazy\" decoding=\"async\"\nstyle=\"max-width:100%;height:auto;border-radius:10px;box-shadow:0 10px 40px rgba(0,0,0,.35)\"\nalt=\"Ingresso de evento gerado pelo PL_FPDF: cabeçalho colorido, QR Code e código de barras\">\n</picture>",
